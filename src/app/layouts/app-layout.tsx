  ...
  return (
    <div className="min-h-screen bg-shell text-slate-950 lg:h-screen lg:overflow-hidden">
      <div className="mx-auto grid min-h-screen max-w-[1640px] grid-cols-1 gap-0 px-3 py-3 lg:h-screen lg:grid-cols-[272px_1fr]">
        ...
        <div className="flex min-h-screen flex-col overflow-hidden rounded-[28px] border border-[rgb(var(--theme-app-border)_/_0.82)] bg-[rgb(var(--theme-app-panel)_/_0.9)] shadow-soft backdrop-blur-sm lg:h-[calc(100vh-24px)]">
