      ...
      <div className="grid gap-6 xl:grid-cols-[0.82fr_1.18fr]">
        ...
        <Card className="border-slate-200/70">
          <div className="border-b border-slate-200/80 pb-5">
            ...
            <h2 className="mt-2 text-[24px] font-semibold tracking-[-0.03em] text-slate-950">워크스페이스 환경</h2>
          ...
          <div className="mt-6 grid gap-6">
            ...
            <div className="rounded-[24px] border border-slate-200/80 bg-white/92 p-5">
              <div className="flex flex-col gap-2 border-b border-slate-200/80 pb-4">
                ...
                <h3 className="text-[20px] font-semibold tracking-[-0.02em] text-slate-950">앱 색상 테마</h3>
